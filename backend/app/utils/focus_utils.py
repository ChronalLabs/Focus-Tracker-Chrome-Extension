...
# functions
def extract_domain(url:str) -> str : # converts any url into string
    try: 
...
def generate_suggestion(focus_score: float, distractive_time: float, top_distracting: list, streak_days: int) -> str : 
    distracting_hours= distractive_time/3600 # converts into hours
